...
def average_complexity(ships: dict[int,TargetShip]):
    ...
    # Save the results
    with open(f"/home/s2075466/aisplanner/results/avg_smoothness_raw_zoom.pkl","wb") as f:
        pickle.dump(smthness,f)
        
    # Save the counts
    with open(f"/home/s2075466/aisplanner/results/avg_smoothness_raw_counts_zoom.pkl","wb") as f:
